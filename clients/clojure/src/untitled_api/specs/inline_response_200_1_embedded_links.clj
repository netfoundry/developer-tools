(ns untitled-api.specs.inline-response-200-1-embedded-links
...
(def inline-response-200-1-embedded-links-data
  {
...
(def inline-response-200-1-embedded-links-spec
  (ds/spec
    {:name ::inline-response-200-1-embedded-links
     :spec inline-response-200-1-embedded-links-data}))
