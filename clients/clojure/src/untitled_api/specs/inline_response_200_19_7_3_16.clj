(ns untitled-api.specs.inline-response-200-19-7-3-16
...
(def inline-response-200-19-7-3-16-data
  {
   ...
   (ds/req :zitiFabricBinary) string?
   ...
   (ds/req :zitiFabricBinarysha-256) string?
...
(def inline-response-200-19-7-3-16-spec
  (ds/spec
    {:name ::inline-response-200-19-7-3-16
     :spec inline-response-200-19-7-3-16-data}))
