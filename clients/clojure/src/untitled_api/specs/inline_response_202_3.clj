(ns untitled-api.specs.inline-response-202-3
...
(def inline-response-202-3-spec
  (ds/spec
    {:name ::inline-response-202-3
     :spec inline-response-202-3-data}))
