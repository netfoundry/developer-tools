(ns untitled-api.specs.inline-response-200-3-embedded-config-id-by-config-type-id
...
(def inline-response-200-3-embedded-config-id-by-config-type-id-data
  {
   ...
   (ds/opt :170c6b9b-f010-46a1-a2ee-cd6729e1f5dc) string?
   (ds/opt :ea6e632b-d8e1-420f-bd8f-ad50b067bad6) string?
   })

(def inline-response-200-3-embedded-config-id-by-config-type-id-spec
  (ds/spec
    {:name ::inline-response-200-3-embedded-config-id-by-config-type-id
     :spec inline-response-200-3-embedded-config-id-by-config-type-id-data}))
