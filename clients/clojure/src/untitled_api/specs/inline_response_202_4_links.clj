(ns untitled-api.specs.inline-response-202-4-links
...
(def inline-response-202-4-links-data
  {
   (ds/req :services) inline-response-200-links-self-spec
   (ds/req :process-execution) inline-response-200-links-network-spec
...
(def inline-response-202-4-links-spec
  (ds/spec
    {:name ::inline-response-202-4-links
     :spec inline-response-202-4-links-data}))
