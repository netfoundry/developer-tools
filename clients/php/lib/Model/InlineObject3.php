...
class InlineObject3 implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'model' => '\OpenAPI\Client\Model\CoreV2ServicesServiceIdModel',
        'model_type' => 'string',
        'name' => 'string'
    ];
     ...
     * Gets model
     *
     * @return \OpenAPI\Client\Model\CoreV2ServicesServiceIdModel
     */
     ...
     * Sets model
     *
     * @param \OpenAPI\Client\Model\CoreV2ServicesServiceIdModel $model model
     *
     * @return $this
     */
