...
#
package WWW::OpenAPIClient::Object::CoreV2ServicesServiceIdModel;
...
__PACKAGE__->method_documentation({
    ...
    'client_ingress' => {
        datatype => 'CoreV2ServicesServiceIdModelClientIngress',
    ...
    'server_egress' => {
        datatype => 'CoreV2ServicesServiceIdModelServerEgress',
