...
#
package WWW::OpenAPIClient::Object::InlineResponse2003EmbeddedServiceList;
...
__PACKAGE__->method_documentation({
    ...
    'model' => {
        datatype => 'InlineResponse2003EmbeddedModel',
        base_name => 'model',
        description => '',
        format => '',
        read_only => '',
    ...
    'config_id_by_config_type_id' => {
        datatype => 'InlineResponse2003EmbeddedConfigIdByConfigTypeId',
