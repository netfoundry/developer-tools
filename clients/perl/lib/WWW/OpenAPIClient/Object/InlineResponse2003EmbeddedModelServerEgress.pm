...
#
package WWW::OpenAPIClient::Object::InlineResponse2003EmbeddedModelServerEgress;
...
__PACKAGE__->method_documentation({
    ...
    'dial_intercept_address' => {
        datatype => 'AnyType',
        base_name => 'dialInterceptAddress',
        description => '',
        format => '',
        read_only => '',
            },
    ...
    'dial_intercept_protocol' => {
        datatype => 'boolean',
        base_name => 'dialInterceptProtocol',
        description => '',
        format => '',
        read_only => '',
            },
