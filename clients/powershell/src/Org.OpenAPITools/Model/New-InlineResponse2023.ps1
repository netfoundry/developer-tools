function New-InlineResponse2023 {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating object: Org.OpenAPITools.Model.InlineResponse2023' | Write-Verbose
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        New-Object -TypeName Org.OpenAPITools.Model.InlineResponse2023 -ArgumentList @(
            ${deletedAt},
            ${networkId},
            ${name},
            ${updatedAt},
