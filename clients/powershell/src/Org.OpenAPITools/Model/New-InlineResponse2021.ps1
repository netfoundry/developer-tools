function New-InlineResponse2021 {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating object: Org.OpenAPITools.Model.InlineResponse2021' | Write-Verbose
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        New-Object -TypeName Org.OpenAPITools.Model.InlineResponse2021 -ArgumentList @(
            ${deletedAt},
            ${networkId},
            ${name},
            ${updatedAt},
