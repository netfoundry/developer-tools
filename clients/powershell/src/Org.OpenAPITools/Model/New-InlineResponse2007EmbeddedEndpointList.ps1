function New-InlineResponse2007EmbeddedEndpointList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating object: Org.OpenAPITools.Model.InlineResponse2007EmbeddedEndpointList' | Write-Verbose
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        New-Object -TypeName Org.OpenAPITools.Model.InlineResponse2007EmbeddedEndpointList -ArgumentList @(
            ${mfaEnabled},
            ${deletedAt},
            ${networkId},
            ${name},
