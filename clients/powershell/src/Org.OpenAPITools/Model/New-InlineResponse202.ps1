function New-InlineResponse202 {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating object: Org.OpenAPITools.Model.InlineResponse202' | Write-Verbose
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        New-Object -TypeName Org.OpenAPITools.Model.InlineResponse202 -ArgumentList @(
            ${deletedAt},
            ${name},
            ${updatedAt},
            ${size},
