...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse2023Model :  IEquatable<InlineResponse2023Model>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2023Model" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse2023Model() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2023Model" /> class.
        /// </summary>
        ...
        public InlineResponse2023Model(List<string> bindEndpointAttributes = default(List<string>), InlineResponse2023ModelClientIngress clientIngress = default(InlineResponse2023ModelClientIngress), List<string> edgeRouterAttributes = default(List<string>), CoreV2ServicesServiceIdModelServerEgress serverEgress = default(CoreV2ServicesServiceIdModelServerEgress))
        {
            // to ensure "bindEndpointAttributes" is required (not null)
            if (bindEndpointAttributes == null)
            {
                throw new InvalidDataException("bindEndpointAttributes is a required property for InlineResponse2023Model and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("clientIngress is a required property for InlineResponse2023Model and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("edgeRouterAttributes is a required property for InlineResponse2023Model and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("serverEgress is a required property for InlineResponse2023Model and cannot be null");
            }
            else
            {
        ...
        public InlineResponse2023ModelClientIngress ClientIngress { get; set; }
        ...
        {
            return this.Equals(input as InlineResponse2023Model);
        }

        /// <summary>
        /// Returns true if InlineResponse2023Model instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2023Model to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2023Model input)
        {
            if (input == null)
                return false;
