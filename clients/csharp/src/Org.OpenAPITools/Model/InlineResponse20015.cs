...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class InlineResponse20015 :  IEquatable<InlineResponse20015>, IValidatableObject
    {
        ...
        public InlineResponse20015(InlineResponse20015Embedded embedded = default(InlineResponse20015Embedded), InlineResponse2002EmbeddedLinks links = default(InlineResponse2002EmbeddedLinks), InlineResponse2001Page page = default(InlineResponse2001Page))
        {
            // to ensure "embedded" is required (not null)
            if (embedded == null)
            {
                throw new InvalidDataException("embedded is a required property for InlineResponse20015 and cannot be null");
            }
            else
            {
            ...
            if (links == null)
            {
                throw new InvalidDataException("links is a required property for InlineResponse20015 and cannot be null");
            }
            else
            {
                this.Links = links;
            ...
            if (page == null)
            {
                throw new InvalidDataException("page is a required property for InlineResponse20015 and cannot be null");
            }
            else
            {
                this.Page = page;
        ...
        public InlineResponse20015Embedded Embedded { get; set; }
