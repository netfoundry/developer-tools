...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class InlineResponse2006 :  IEquatable<InlineResponse2006>, IValidatableObject
    {
        ...
        public InlineResponse2006(InlineResponse2006Embedded embedded = default(InlineResponse2006Embedded), InlineResponse2002EmbeddedLinks links = default(InlineResponse2002EmbeddedLinks), InlineResponse2001Page page = default(InlineResponse2001Page))
        {
            // to ensure "links" is required (not null)
            if (links == null)
            {
                throw new InvalidDataException("links is a required property for InlineResponse2006 and cannot be null");
            }
            else
            {
                this.Links = links;
            ...
            if (page == null)
            {
                throw new InvalidDataException("page is a required property for InlineResponse2006 and cannot be null");
            }
            else
            {
                this.Page = page;
