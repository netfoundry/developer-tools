...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class InlineResponse2001 :  IEquatable<InlineResponse2001>, IValidatableObject
    {
        ...
        public InlineResponse2001(InlineResponse2001Embedded embedded = default(InlineResponse2001Embedded), InlineResponse2001Links links = default(InlineResponse2001Links), InlineResponse2001Page page = default(InlineResponse2001Page))
        {
            // to ensure "embedded" is required (not null)
            if (embedded == null)
            {
                throw new InvalidDataException("embedded is a required property for InlineResponse2001 and cannot be null");
            }
            else
            {
            ...
            if (links == null)
            {
                throw new InvalidDataException("links is a required property for InlineResponse2001 and cannot be null");
            }
            else
            {
                this.Links = links;
            ...
            if (page == null)
            {
                throw new InvalidDataException("page is a required property for InlineResponse2001 and cannot be null");
            }
            else
            {
                this.Page = page;
