...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse2021Links :  IEquatable<InlineResponse2021Links>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2021Links" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse2021Links() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2021Links" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as InlineResponse2021Links);
        }

        /// <summary>
        /// Returns true if InlineResponse2021Links instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2021Links to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2021Links input)
        {
            if (input == null)
                return false;
