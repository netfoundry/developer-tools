...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class InlineResponse20018 :  IEquatable<InlineResponse20018>, IValidatableObject
    {
        ...
        public InlineResponse20018(InlineResponse20018Embedded embedded = default(InlineResponse20018Embedded), InlineResponse2002EmbeddedLinks links = default(InlineResponse2002EmbeddedLinks), InlineResponse2001Page page = default(InlineResponse2001Page))
        {
            // to ensure "links" is required (not null)
            if (links == null)
            {
                throw new InvalidDataException("links is a required property for InlineResponse20018 and cannot be null");
            }
            else
            {
                this.Links = links;
            ...
            if (page == null)
            {
                throw new InvalidDataException("page is a required property for InlineResponse20018 and cannot be null");
            }
            else
            {
                this.Page = page;
        ...
        public InlineResponse20018Embedded Embedded { get; set; }
