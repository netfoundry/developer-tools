...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse2001EmbeddedLinks :  IEquatable<InlineResponse2001EmbeddedLinks>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2001EmbeddedLinks" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse2001EmbeddedLinks() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2001EmbeddedLinks" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as InlineResponse2001EmbeddedLinks);
        }

        /// <summary>
        /// Returns true if InlineResponse2001EmbeddedLinks instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2001EmbeddedLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2001EmbeddedLinks input)
        {
            if (input == null)
                return false;
