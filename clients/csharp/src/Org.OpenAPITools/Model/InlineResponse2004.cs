...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class InlineResponse2004 :  IEquatable<InlineResponse2004>, IValidatableObject
    {
        ...
        public InlineResponse2004(InlineResponse2004Embedded embedded = default(InlineResponse2004Embedded), InlineResponse2002EmbeddedLinks links = default(InlineResponse2002EmbeddedLinks), InlineResponse2001Page page = default(InlineResponse2001Page))
        {
            // to ensure "links" is required (not null)
            if (links == null)
            {
                throw new InvalidDataException("links is a required property for InlineResponse2004 and cannot be null");
            }
            else
            {
                this.Links = links;
        ...
        public InlineResponse2004Embedded Embedded { get; set; }
