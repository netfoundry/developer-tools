...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class InlineObject6 :  IEquatable<InlineObject6>, IValidatableObject
    {
        ...
        /// <param name="dataCenterId">dataCenterId.</param>
        public InlineObject6(string networkId = default(string), string name = default(string), List<string> attributes = default(List<string>), bool linkListener = default(bool), string dataCenterId = default(string))
        {
            // to ensure "networkId" is required (not null)
            if (networkId == null)
            {
                throw new InvalidDataException("networkId is a required property for InlineObject6 and cannot be null");
            }
            else
            {
            ...
            if (attributes == null)
            {
                throw new InvalidDataException("attributes is a required property for InlineObject6 and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("linkListener is a required property for InlineObject6 and cannot be null");
            }
            else
            {
