-module(openapi_inline_response_200_5_config_id_by_config_type_id).

-export([encode/1]).

-export_type([openapi_inline_response_200_5_config_id_by_config_type_id/0]).

-type openapi_inline_response_200_5_config_id_by_config_type_id() ::
