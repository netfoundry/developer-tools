-module(openapi_inline_response_200_1__embedded__links).

-export([encode/1]).

-export_type([openapi_inline_response_200_1__embedded__links/0]).

-type openapi_inline_response_200_1__embedded__links() ::
