-module(openapi_inline_response_202_1).

-export([encode/1]).

-export_type([openapi_inline_response_202_1/0]).

-type openapi_inline_response_202_1() ::
    #{ 'deletedAt' := openapi_any_type:openapi_any_type(),
       ...
       'modelType' := binary(),
       'id' := binary(),
       'configIdByConfigTypeId' := openapi_inline_response_202_1_config_id_by_config_type_id:openapi_inline_response_202_1_config_id_by_config_type_id(),
       'createdAt' := binary(),
       'createdBy' := binary(),
