...
public struct InlineResponse2005: Codable { 
    ...
    public var configIdByConfigTypeId: InlineResponse2005ConfigIdByConfigTypeId
    ...
    public init(deletedAt: AnyType, networkId: String, name: String, updatedAt: String, model: InlineResponse2003EmbeddedModel, zitiId: String, ownerIdentityId: String, attributes: [String], modelType: String, id: String, configIdByConfigTypeId: InlineResponse2005ConfigIdByConfigTypeId, createdAt: String, createdBy: String, deletedBy: AnyType, encryptionRequired: Bool, authority: AnyType, links: InlineResponse200Links) {
