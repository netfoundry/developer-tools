...
public struct InlineResponse2008: Codable { 
    ...
    public init(mfaEnabled: Bool, deletedAt: AnyType, networkId: String, name: String, updatedAt: String, syncId: AnyType, sessionIdentityId: AnyType, osRelease: AnyType, syncResourceId: AnyType, zitiId: String, appVersion: AnyType, branch: AnyType, os: AnyType, ownerIdentityId: String, hasEdgeRouterConnection: Bool, attributes: [String], hasApiSession: Bool, revision: AnyType, version: AnyType, jwt: String, id: String, sessionActive: Bool, jwtExpiresAt: String, createdAt: String, arch: AnyType, createdBy: String, deletedBy: AnyType, type: AnyType, osVersion: AnyType, appId: AnyType, links: InlineResponse200Links) {
