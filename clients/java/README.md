...
untitled API
- API version: 5170
  - Build date: 2021-04-12T16:43:17.497575-04:00[America/New_York]
...
```groovy
compile "org.openapitools:openapi-java-client:5170"
```
...
* `target/openapi-java-client-5170.jar`
* `target/lib/*.jar`
