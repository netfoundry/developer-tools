...
class InlineResponse2008 {
  ...
  @override
  String toString() {
    return 'InlineResponse2008[mfaEnabled=$mfaEnabled, deletedAt=$deletedAt, networkId=$networkId, name=$name, updatedAt=$updatedAt, syncId=$syncId, sessionIdentityId=$sessionIdentityId, osRelease=$osRelease, syncResourceId=$syncResourceId, zitiId=$zitiId, appVersion=$appVersion, branch=$branch, os=$os, ownerIdentityId=$ownerIdentityId, hasEdgeRouterConnection=$hasEdgeRouterConnection, attributes=$attributes, hasApiSession=$hasApiSession, revision=$revision, version=$version, jwt=$jwt, id=$id, sessionActive=$sessionActive, jwtExpiresAt=$jwtExpiresAt, createdAt=$createdAt, arch=$arch, createdBy=$createdBy, deletedBy=$deletedBy, type=$type, osVersion=$osVersion, appId=$appId, links=$links, ]';
  }
