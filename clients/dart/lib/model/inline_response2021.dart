...
class InlineResponse2021 {
  ...
  InlineResponse2021ConfigIdByConfigTypeId configIdByConfigTypeId = null;
  ...
  @override
  String toString() {
    return 'InlineResponse2021[deletedAt=$deletedAt, networkId=$networkId, name=$name, updatedAt=$updatedAt, model=$model, zitiId=$zitiId, ownerIdentityId=$ownerIdentityId, attributes=$attributes, modelType=$modelType, id=$id, configIdByConfigTypeId=$configIdByConfigTypeId, createdAt=$createdAt, createdBy=$createdBy, deletedBy=$deletedBy, encryptionRequired=$encryptionRequired, authority=$authority, links=$links, ]';
  }
  ...
  InlineResponse2021.fromJson(Map<String, dynamic> json) {
    ...
    configIdByConfigTypeId = (json['configIdByConfigTypeId'] == null) ?
      null :
      InlineResponse2021ConfigIdByConfigTypeId.fromJson(json['configIdByConfigTypeId']);
