...
pub struct InlineResponse2007 {
    ...
    pub _embedded: Option<crate::models::InlineResponse2007Embedded>,
    #[serde(rename = "_links")]
...
impl InlineResponse2007 {
    pub fn new(_links: crate::models::InlineResponse2002EmbeddedLinks, page: crate::models::InlineResponse2001Page) -> InlineResponse2007 {
        InlineResponse2007 {
            _embedded: None,
            _links,
            page,
