...
pub struct InlineResponse2004 {
    ...
    pub _embedded: Option<crate::models::InlineResponse2004Embedded>,
    #[serde(rename = "_links")]
...
impl InlineResponse2004 {
    pub fn new(_links: crate::models::InlineResponse2002EmbeddedLinks, page: crate::models::InlineResponse2001Page) -> InlineResponse2004 {
        InlineResponse2004 {
            _embedded: None,
            _links,
            page,
