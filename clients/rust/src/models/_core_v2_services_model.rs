...
pub struct CoreV2ServicesModel {
    ...
    pub client_ingress: crate::models::CoreV2ServicesModelClientIngress,
    #[serde(rename = "edgeRouterHosts", skip_serializing_if = "Option::is_none")]
    pub edge_router_hosts: Option<Vec<crate::models::CoreV2ServicesModelEdgeRouterHosts>>,
}

impl CoreV2ServicesModel {
    pub fn new(edge_router_attributes: Vec<String>, client_ingress: crate::models::CoreV2ServicesModelClientIngress) -> CoreV2ServicesModel {
        CoreV2ServicesModel {
