...
pub struct InlineResponse2003 {
    ...
    pub _embedded: Option<crate::models::InlineResponse2003Embedded>,
    #[serde(rename = "_links")]
...
impl InlineResponse2003 {
    pub fn new(_links: crate::models::InlineResponse2002EmbeddedLinks, page: crate::models::InlineResponse2001Page) -> InlineResponse2003 {
        InlineResponse2003 {
            _embedded: None,
            _links,
            page,
