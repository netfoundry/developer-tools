...
class InlineResponse2007 {
    ...
    constructor(links, page) { 
        ...
        InlineResponse2007.initialize(this, links, page);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('_embedded')) {
                obj['_embedded'] = InlineResponse2007Embedded.constructFromObject(data['_embedded']);
            }
...
/**
 * @member {module:model/InlineResponse2007Embedded} _embedded
 */
InlineResponse2007.prototype['_embedded'] = undefined;

/**
 * @member {module:model/InlineResponse2002EmbeddedLinks} _links
 */
InlineResponse2007.prototype['_links'] = undefined;
