...
class InlineResponse20018 {
    ...
    constructor(links, page) { 
        ...
        InlineResponse20018.initialize(this, links, page);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('_embedded')) {
                obj['_embedded'] = InlineResponse20018Embedded.constructFromObject(data['_embedded']);
            }
...
/**
 * @member {module:model/InlineResponse20018Embedded} _embedded
 */
InlineResponse20018.prototype['_embedded'] = undefined;

/**
 * @member {module:model/InlineResponse2002EmbeddedLinks} _links
 */
InlineResponse20018.prototype['_links'] = undefined;

/**
 * @member {module:model/InlineResponse2001Page} page
 */
InlineResponse20018.prototype['page'] = undefined;
