...
/**
 * The InlineResponse2024Links model module.
 * @module model/InlineResponse2024Links
 * @version 5227
 */
class InlineResponse2024Links {
    /**
     * Constructs a new <code>InlineResponse2024Links</code>.
     * @alias module:model/InlineResponse2024Links
     * @param services {module:model/InlineResponse200LinksSelf} 
     * @param processExecution {module:model/InlineResponse200LinksNetwork} 
     ...
     */
    constructor(services, processExecution, networks, appWans, endpoints, certificateAuthorities, self, processExecutions, networkControllers, postureChecks, edgeRouters, edgeRouterPolicies) { 
        
        InlineResponse2024Links.initialize(this, services, processExecution, networks, appWans, endpoints, certificateAuthorities, self, processExecutions, networkControllers, postureChecks, edgeRouters, edgeRouterPolicies);
    }
     ...
     */
    static initialize(obj, services, processExecution, networks, appWans, endpoints, certificateAuthorities, self, processExecutions, networkControllers, postureChecks, edgeRouters, edgeRouterPolicies) { 
        obj['services'] = services;
        obj['process-execution'] = processExecution;
    ...
    /**
     * Constructs a <code>InlineResponse2024Links</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InlineResponse2024Links} obj Optional instance to populate.
     * @return {module:model/InlineResponse2024Links} The populated <code>InlineResponse2024Links</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InlineResponse2024Links();

            if (data.hasOwnProperty('services')) {
                obj['services'] = InlineResponse200LinksSelf.constructFromObject(data['services']);
            }
            if (data.hasOwnProperty('process-execution')) {
                obj['process-execution'] = InlineResponse200LinksNetwork.constructFromObject(data['process-execution']);
            }
 ...
 */
InlineResponse2024Links.prototype['services'] = undefined;

/**
 * @member {module:model/InlineResponse200LinksNetwork} process-execution
 */
InlineResponse2024Links.prototype['process-execution'] = undefined;

/**
 * @member {module:model/InlineResponse200LinksNetwork} networks
 */
InlineResponse2024Links.prototype['networks'] = undefined;

/**
 * @member {module:model/InlineResponse200LinksSelf} app-wans
 */
InlineResponse2024Links.prototype['app-wans'] = undefined;

/**
 * @member {module:model/InlineResponse200LinksSelf} endpoints
 */
InlineResponse2024Links.prototype['endpoints'] = undefined;

/**
 * @member {module:model/InlineResponse200LinksSelf} certificate-authorities
 */
InlineResponse2024Links.prototype['certificate-authorities'] = undefined;

/**
 * @member {module:model/InlineResponse200LinksSelf} self
 */
InlineResponse2024Links.prototype['self'] = undefined;

/**
 * @member {module:model/InlineResponse200LinksNetwork} process-executions
 */
InlineResponse2024Links.prototype['process-executions'] = undefined;

/**
 * @member {module:model/InlineResponse200LinksSelf} network-controllers
 */
InlineResponse2024Links.prototype['network-controllers'] = undefined;

/**
 * @member {module:model/InlineResponse200LinksSelf} posture-checks
 */
InlineResponse2024Links.prototype['posture-checks'] = undefined;

/**
 * @member {module:model/InlineResponse200LinksSelf} edge-routers
 */
InlineResponse2024Links.prototype['edge-routers'] = undefined;

/**
 * @member {module:model/InlineResponse200LinksSelf} edge-router-policies
 */
InlineResponse2024Links.prototype['edge-router-policies'] = undefined;
...
export default InlineResponse2024Links;
