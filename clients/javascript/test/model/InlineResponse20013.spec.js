...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new UntitledApi.InlineResponse20013();
  });
  ...
  describe('InlineResponse20013', function() {
    it('should create an instance of InlineResponse20013', function() {
      ...
      //var instane = new UntitledApi.InlineResponse20013();
      //expect(instance).to.be.a(UntitledApi.InlineResponse20013);
    });
    ...
    it('should have the property sdsPassword (base name: "sdsPassword")', function() {
      // uncomment below and update the code to test the property sdsPassword
      //var instane = new UntitledApi.InlineResponse20013();
      //expect(instance).to.be();
    });
