...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new UntitledApi.InlineResponse2003EmbeddedModel();
  });
  ...
  describe('InlineResponse2003EmbeddedModel', function() {
    it('should create an instance of InlineResponse2003EmbeddedModel', function() {
      // uncomment below and update the code to test InlineResponse2003EmbeddedModel
      //var instane = new UntitledApi.InlineResponse2003EmbeddedModel();
      //expect(instance).to.be.a(UntitledApi.InlineResponse2003EmbeddedModel);
    });
