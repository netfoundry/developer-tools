...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new UntitledApi.InlineResponse2023Model();
  });
  ...
  describe('InlineResponse2023Model', function() {
    it('should create an instance of InlineResponse2023Model', function() {
      // uncomment below and update the code to test InlineResponse2023Model
      //var instane = new UntitledApi.InlineResponse2023Model();
      //expect(instance).to.be.a(UntitledApi.InlineResponse2023Model);
    });
