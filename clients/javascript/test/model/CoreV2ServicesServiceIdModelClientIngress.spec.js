...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new UntitledApi.CoreV2ServicesServiceIdModelClientIngress();
  });
  ...
  describe('CoreV2ServicesServiceIdModelClientIngress', function() {
    it('should create an instance of CoreV2ServicesServiceIdModelClientIngress', function() {
      // uncomment below and update the code to test CoreV2ServicesServiceIdModelClientIngress
      //var instane = new UntitledApi.CoreV2ServicesServiceIdModelClientIngress();
      //expect(instance).to.be.a(UntitledApi.CoreV2ServicesServiceIdModelClientIngress);
    });
