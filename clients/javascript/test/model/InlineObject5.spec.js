...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new UntitledApi.InlineObject5();
  });
  ...
  describe('InlineObject5', function() {
    it('should create an instance of InlineObject5', function() {
      ...
      //var instane = new UntitledApi.InlineObject5();
      //expect(instance).to.be.a(UntitledApi.InlineObject5);
    });
    ...
    it('should have the property enrollmentMethod (base name: "enrollmentMethod")', function() {
      // uncomment below and update the code to test the property enrollmentMethod
      //var instane = new UntitledApi.InlineObject5();
      //expect(instance).to.be();
    });
