...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new UntitledApi.InlineResponse2001EmbeddedNetworkList();
  });
  ...
  describe('InlineResponse2001EmbeddedNetworkList', function() {
    it('should create an instance of InlineResponse2001EmbeddedNetworkList', function() {
      // uncomment below and update the code to test InlineResponse2001EmbeddedNetworkList
      //var instane = new UntitledApi.InlineResponse2001EmbeddedNetworkList();
      //expect(instance).to.be.a(UntitledApi.InlineResponse2001EmbeddedNetworkList);
    });
