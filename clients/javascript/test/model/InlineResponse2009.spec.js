...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new UntitledApi.InlineResponse2009();
  });
  ...
  describe('InlineResponse2009', function() {
    it('should create an instance of InlineResponse2009', function() {
      ...
      //var instane = new UntitledApi.InlineResponse2009();
      //expect(instance).to.be.a(UntitledApi.InlineResponse2009);
    });
    ...
    it('should have the property registrationKey (base name: "registrationKey")', function() {
      // uncomment below and update the code to test the property registrationKey
      //var instane = new UntitledApi.InlineResponse2009();
      //expect(instance).to.be();
    });
