 ...
 * @param zitiFabricBinaryPeriodShaMinus256 
 ...
 * @param zitiFabricBinaryPeriodMd5 
 * @param zitiTunnelLinuxBinaryPeriodMd5 
 * @param zitiRouterLinuxArmBinary 
 * @param zitiFabricBinaryPeriodShaMinus1 
...
data class InlineResponse200197316 (
    ...
    @Json(name = "zitiFabricBinary")
    val zitiFabricBinary: kotlin.String,
    ...
    @Json(name = "zitiFabricBinary.sha-256")
    val zitiFabricBinaryPeriodShaMinus256: kotlin.String,
    ...
    @Json(name = "zitiFabricBinary.md5")
    val zitiFabricBinaryPeriodMd5: kotlin.String,
    ...
    @Json(name = "zitiFabricBinary.sha-1")
    val zitiFabricBinaryPeriodShaMinus1: kotlin.String,
