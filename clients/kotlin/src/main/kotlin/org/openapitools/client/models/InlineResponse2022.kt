...
import org.openapitools.client.models.InlineResponse2022ConfigIdByConfigTypeId
...
data class InlineResponse2022 (
    ...
    val attributes: AnyType,
    @Json(name = "modelType")
    val modelType: kotlin.String,
    @Json(name = "id")
    val id: kotlin.String,
    @Json(name = "configIdByConfigTypeId")
    val configIdByConfigTypeId: InlineResponse2022ConfigIdByConfigTypeId,
    @Json(name = "createdAt")
    val createdAt: kotlin.String,
    @Json(name = "createdBy")
    val createdBy: kotlin.String,
    @Json(name = "deletedBy")
    val deletedBy: kotlin.String,
