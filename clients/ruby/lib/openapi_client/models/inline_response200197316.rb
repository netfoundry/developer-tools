...
module OpenapiClient
  class InlineResponse200197316
    ...
    attr_accessor :ziti_fabric_binary
    ...
    attr_accessor :ziti_fabric_binary_sha_256
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::InlineResponse200197316` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::InlineResponse200197316`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'ziti_fabric_binary')
        self.ziti_fabric_binary = attributes[:'ziti_fabric_binary']
      end
      ...
      if attributes.key?(:'ziti_fabric_binary_sha_256')
        self.ziti_fabric_binary_sha_256 = attributes[:'ziti_fabric_binary_sha_256']
      end
      ...
      if attributes.key?(:'ziti_fabric_binary_md5')
        self.ziti_fabric_binary_md5 = attributes[:'ziti_fabric_binary_md5']
      end
      ...
      if attributes.key?(:'ziti_fabric_binary_sha_1')
        self.ziti_fabric_binary_sha_1 = attributes[:'ziti_fabric_binary_sha_1']
      end
    ...
    def list_invalid_properties
      ...
      if @ziti_fabric_binary.nil?
        invalid_properties.push('invalid value for "ziti_fabric_binary", ziti_fabric_binary cannot be nil.')
      end
      ...
      if @ziti_fabric_binary_sha_256.nil?
        invalid_properties.push('invalid value for "ziti_fabric_binary_sha_256", ziti_fabric_binary_sha_256 cannot be nil.')
      end
      ...
      if @ziti_fabric_binary_md5.nil?
        invalid_properties.push('invalid value for "ziti_fabric_binary_md5", ziti_fabric_binary_md5 cannot be nil.')
      end
      ...
      if @ziti_fabric_binary_sha_1.nil?
        invalid_properties.push('invalid value for "ziti_fabric_binary_sha_1", ziti_fabric_binary_sha_1 cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @ziti_fabric_binary.nil?
      ...
      return false if @ziti_fabric_binary_sha_256.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          ziti_fabric_binary == o.ziti_fabric_binary &&
          ...
          ziti_fabric_binary_sha_256 == o.ziti_fabric_binary_sha_256 &&
    ...
    def hash
      [ziti_cli_linux_binary_sha_1, ziti_tunnel_linux_binary, ziti_tunnel_linux_binary_sha_1, ziti_controller_binary, ziti_cli_linux_binary_md5, ziti_router_linux_binary_sha_1, ziti_router_linux_arm_binary_md5, ziti_router_linux_binary_sha_256, ziti_cli_linux_arm_binary, ziti_router_linux_binary_md5, ziti_windows_desktop_edge, ziti_router_linux_arm_binary_sha_256, ziti_mac_desktop_edge, ziti_controller_binary_sha_1, ziti_controller_binary_md5, ziti_controller_binary_sha_256, ziti_ios_edge, ziti_cli_linux_binary, ziti_router_linux_arm_binary_sha_1, ziti_version, ziti_fabric_binary, ziti_cli_linux_arm_binary_sha_1, ziti_tunnel_linux_arm_binary_sha_1, ziti_tunnel_linux_arm_binary, ziti_cli_linux_arm_binary_sha_256, ziti_fabric_binary_sha_256, ziti_router_linux_binary, ziti_tunnel_linux_binary_sha_256, ziti_android_edge, ziti_tunnel_linux_arm_binary_md5, ziti_fabric_binary_md5, ziti_tunnel_linux_binary_md5, ziti_router_linux_arm_binary, ziti_fabric_binary_sha_1, ziti_cli_linux_arm_binary_md5, ziti_tunnel_linux_arm_binary_sha_256, ziti_cli_linux_binary_sha_256, active].hash
    end
