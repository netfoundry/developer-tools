  ...
  class InlineResponse2021ConfigIdByConfigTypeId
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::InlineResponse2021ConfigIdByConfigTypeId` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::InlineResponse2021ConfigIdByConfigTypeId`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @e7f6ef8d_da57_444c_b677_f03974f5d8be.nil?
        invalid_properties.push('invalid value for "e7f6ef8d_da57_444c_b677_f03974f5d8be", e7f6ef8d_da57_444c_b677_f03974f5d8be cannot be nil.')
      end
    ...
    def valid?
      return false if @e7f6ef8d_da57_444c_b677_f03974f5d8be.nil?
      true
    end
    ...
    def hash
      [_6fa5c2bc_b7f7_47f8_9229_e927722adb27, _7491e52d_97e8_4759_8a63_c8ea8a75f822, b1582680_ab7b_45d0_ac36_b00f82df8e79, e7f6ef8d_da57_444c_b677_f03974f5d8be].hash
    end
